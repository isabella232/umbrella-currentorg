<?php
/**
 * Template Name: Hearken Series Landing Page Default
 * Description: The default template for a hearken series landing page. Many display options are set via admin.
 */
get_header();
...
<div id="content" class="span<?php echo $content_span[ $opt['cftl_layout'] ]; ?> stories" role="main">
  ...
  <div id="h3ac1" class="hkn-vote-module" data-pym-src="//modules.wearehearken.com/current/voting_modules/legacy"></div>
  <h1 class='entry-title'>Previous <?php the_title(); ?> Stories</h1>
<?php
